...
<body>
    ...
    <div id="TambahUser-overlay" class="overlay">
        <div class="overlay-content">
            ...
            <form id="form-tambah" class="form-tambah" action="tambah-user.php" method="POST">
    ...
    <div id="EditUser-overlay" class="overlay">
        <div class="overlay-content">
            ...
            <form id="form-tambah" class="form-tambah" action="edit-user.php" method="POST">
                <label for="username">Username:</label>
                <input type="text" id="username" name="username" required>
    ...
    <div id="DeleteUser-overlay" class="overlay">
        <div class="overlay-content">
            ...
            <form id="form-tambah" class="form-tambah" action="hapus-user.php" method="POST">
                <label for="username">Username:</label>
                <input type="text" id="username" name="username" required>
